...
- [Filtered Masking Diffusion advantage](data/research05/figures/filtered_masking_diffusion_advantage_summary.png)
- [Class ratio and F1/recall relationship](data/research05/figures/class_ratio_f1_recall_relationship.png)
- [Training counts and F1/recall relationship](data/research05/figures/training_counts_f1_recall_relationship.png)
...
![Recall stability under precision floor](data/research07/figures/research07_precision90_recall_stability.png)

관련 추가 그림:

- [Threshold robustness comparison](data/research07/figures/research07_threshold_robustness_comparison.png)
- [30-run recall stability comparison](data/research07/figures/research07_stability_recall_comparison.png)
